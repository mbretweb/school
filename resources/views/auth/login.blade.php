                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                <input type="text" class="form-control" name="identity" value="{{ old('identity') }}" placeholder="Email Id">
                            </div>
                            <div class="form-group ">
                           ...
                           <div class="form-group">
                                <a href="{{route('register')}}" class="btn btn-light btn-block"><i class="fa-solid fa-arrow-right-to-bracket"></i> No account yet? Sign Up</a>
                            </div>
                        </div>
                    </div>
                </form>
